...
export function PrivacyModal({ onEnable }: { onEnable: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-background/70 backdrop-blur-sm p-4">
            <div className="bg-card border border-border rounded-xl max-w-md w-full p-6 shadow-2xl animate-in fade-in zoom-in duration-300">
                ...
                <h2 className="text-xl font-bold text-foreground mb-2">Enable Interview Monitoring?</h2>
